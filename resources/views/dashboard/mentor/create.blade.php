...
@section('content')
    ...
    <div class="container">
        <h3 style="color: white">Tambah Mentor</h3>
        <div class="card p-3 mb-3" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px; ">
            <form action="/admin-mentor/create" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="row gap-3 p-3">
                    ...
                    <div class="col ">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="nama" class="form-control @error('nama')is-invalid @enderror"
                                    placeholder="rafli haikal" value="{{ old('nama') }}">
                                @error('nama')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="kategori_mentor_id">
                                    @foreach ($kategoriMentor as $item)
                                        @if (old('kategori_mentor_id') == $item->id)
                        ...
                        <div class="col pt-3">
                            <div class="col">
                                ...
                                <input type="text" name="pekerjaan"
                                    ...
                                    value="{{ old('pekerjaan') }}" placeholder="Desain Grafis PT.Tokopedia">
                                @error('pekerjaan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col pt-3">
                                ...
                                <textarea type="text" name="deskripsi" class="form-control @error('deskripsi')is-invalid @enderror"
                                    placeholder="Saya adalah seorang desain grafis ..." rows="3">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row pt-3">
                            <div class="col">
                                ...
                                <input type="number" name="whatsapp"
                                    ...
                                    value="{{ old('whatsapp') }}" placeholder="0891234567810">
                                @error('whatsapp')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="instagram"
                                    ...
                                    value="{{ old('instagram') }}" placeholder="@rflihaikal">
                                @error('instagram')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="alamat"
                                    ...
                                    placeholder="Jl. Merpati Putih, Padang, Sumatera Barat" value="{{ old('alamat') }}">
                                @error('alamat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <button type="submit" style="float: right" class="btn btn-primary mt-3">Tambah mentor</button>
