...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ route('admin-event.create') }}" class="btn btn-success">Tambah Event</a>
        <div class="row mb-3">
                    ...
                    <div class="card"
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex " style="gap:3px">
                                ...
                                <a href="/admin-event/{{ $item->id }}/edit" class="btn btn-primary btn-sm "
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Lihat Event</h1>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <p class="mt-3" style="text-align: justify">Tanggal : {{ $item->tanggal }}</p>
                                <p class="mt-3" style="text-align: justify">Waktu : {{ $item->waktu }}</p>
                            </div>
