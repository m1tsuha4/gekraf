                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item dropdown " style="margin-right: 40px">
                            ...
                            <ul class="dropdown-menu " style="margin-top:0px !important;--bs-dropdown-min-width: 0rem;">
                                <li><a class="dropdown-item" href="/">Halaman Home</a></li>
                                <li><a class="dropdown-item"
                                        href="https://wa.me/62895341172282?text=Halo haikal">Contact
                                        Developer</a>
                                </li>
                                <li>
