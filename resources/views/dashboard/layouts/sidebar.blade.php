<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header bg-white">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
            ...
            <span class="ms-1 font-weight-bold">Gekraf Sumbar</span>
        </a>
    </div>
...
{{--            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin-event*') ? 'active' : '' }}" href="/admin-event">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-app text-info text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin-pariwisata*') ? 'active' : '' }}" href="/admin-pariwisata">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-app text-info text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Pariwisata</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin-dataAnggota*') ? 'active' : '' }}" href="/admin-dataAnggota">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Anggota Gekraf</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin-dataUmkm*') ? 'active' : '' }}" href="/admin-dataUmkm">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
                    </div>
